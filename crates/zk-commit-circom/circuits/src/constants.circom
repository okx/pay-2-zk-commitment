...
function NUM_WIRES_CAP() { return 2; }
...
function GET_SIGMA_CAP(i) {
  var sc[2][4];
  sc[0][0] = 18269524722532920355;
  sc[0][1] = 15551604216735309306;
  sc[0][2] = 8398906437015191147;
  sc[0][3] = 12194708776855250071;
  sc[1][0] = 15153341424773979389;
  sc[1][1] = 11987478676727139124;
  sc[1][2] = 12569519031780742521;
  sc[1][3] = 9847769891311456651;
  return sc[i];
}
...
function CIRCUIT_DIGEST() {
  var cd[4];
  cd[0] = 8944441571096920250;
  cd[1] = 10022203104064253459;
  cd[2] = 10156564322773314496;
  cd[3] = 12150283174370175057;
  return cd;
}
