...
pub mod pay_commitment {
    ...
    pub static PAYCOMMITMENT_ABI: ::ethers::contract::Lazy<::ethers::core::abi::Abi> = ::ethers::contract::Lazy::new(
        __abi,
    );
    #[rustfmt::skip]
    ...
    pub static PAYCOMMITMENT_BYTECODE: ::ethers::core::types::Bytes = ::ethers::core::types::Bytes::from_static(
        __BYTECODE,
    );
    #[rustfmt::skip]
    ...
    pub static PAYCOMMITMENT_DEPLOYED_BYTECODE: ::ethers::core::types::Bytes = ::ethers::core::types::Bytes::from_static(
        __DEPLOYED_BYTECODE,
    );
    ...
    impl<M> ::core::fmt::Debug for PayCommitment<M> {
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
            f.debug_tuple(::core::stringify!(PayCommitment))
                .field(&self.address())
                .finish()
        }
    }
    ...
    #[ethcall(
        name = "withdraw",
        abi = "withdraw(uint256[2],uint256[2][2],uint256[2],uint256[4])"
    )]
    ...
    impl ::ethers::core::abi::AbiDecode for PayCommitmentCalls {
        fn decode(
            ...
            if let Ok(decoded) = <Groth16VerifierAddressCall as ::ethers::core::abi::AbiDecode>::decode(
                data,
            ) {
            ...
            if let Ok(decoded) = <TokenAddressCall as ::ethers::core::abi::AbiDecode>::decode(
                data,
            ) {
