use plonky2::{hash::hash_types::HashOutTarget, iop::target::Target, plonk::circuit_builder::CircuitBuilder};

use crate::{circuit_config::{COMMITMENT_TREE_DEPTH, D}, circuit_utils::{get_hash_from_input_targets, verify_hash, verify_merkle_proof_fixed_height}, types::F};
