...
fn deposit_usdc(commitment: [u8;32], amount: u64, private_key: [u8;32]) // deposit to contract; better to be implemented by mobile end; can discuss
...
fn claim(groth16_proof: String, private_key: [u8;32]);// for receiver to claim, to be implemented by mobile end;
```